...
import com.gm.warn.filter.URLPathMatchingFilter;
import com.gm.warn.realm.SWRealm;
...
public class ShiroConfiguration {
    ...
    public SecurityManager securityManager() {
        ...
        securityManager.setRealm(getSWSRealm());
    ...
    @Bean
    public SWRealm getSWSRealm() {
        SWRealm SWRealm = new SWRealm();
        SWRealm.setCredentialsMatcher(hashedCredentialsMatcher());
        return SWRealm;
    }
